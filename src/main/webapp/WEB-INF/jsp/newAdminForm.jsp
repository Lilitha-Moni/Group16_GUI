...
<head>
    ...
    <script type="text/javascript">
        ...
        function validateform()
        {
            ...
            else if (phoneNo.length >=11 || phoneN.length <=9)
            {
                document.getElementById("ageErr").innerHTML = " phoneNo cannot be less than 10 digits or more than 10 digits";
                valid = false;
            }
            else{
...
<body>
<form:form action="/admin/create" modelAttribute="admin" method="post" onsubmit="return validateform();"   >
