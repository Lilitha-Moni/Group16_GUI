...
<h3>${subheading}</h3>
<form method="POST">
    <input type="hidden" name="id" value="${empty medicalstaff.id ? medicalstaff.id : 0}">
    <input type="hidden" name="checkups_done" value="${empty medicalstaff.checkupsDone ? medicalstaff.checkupsDone : 0}">
    <input type="hidden" name="medical_emergencies_done" value="${empty medicalstaff.medicalEmergenciesDone ? medicalstaff.checkupsDone : 0}">
